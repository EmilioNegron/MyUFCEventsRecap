...
open class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _navigateToSelectedUFCEvent = MutableLiveData<DevByteEvent>()
    val navigateToSelectedUFCEvent: LiveData<DevByteEvent>
        get() = _navigateToSelectedUFCEvent
    ...
    fun displayUFCEventDetails(devByteEvent: DevByteEvent) {
        _navigateToSelectedUFCEvent.value = devByteEvent
    }

    /**
     * After the navigation has taken place, make sure navigateToSelectedUFCEvent is set to null
     */
    fun displayUFCEventDetailsComplete() {
        _navigateToSelectedUFCEvent.value = null
    }
}
